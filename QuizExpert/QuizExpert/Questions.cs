    ...
    public class Questions
    {
        ...
        public string GenerateQuestion()
        {
            try
            {
                ...
                {
                    questionsList = new List<string>{ "How many bits is one byte?8;1;4;16", "Who made Facebook?Mark Zuckenberg;Elon Musk;Nikola Gruevski;Bill Gates", "What is Java?Programming Language;Video Game;Text Format;Type of coffe" };
                    string q = questionsList[random.Next(0, questionsList.Count)];
                    questionsList.Remove(q);
                    return q;
                }
